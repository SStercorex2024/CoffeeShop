  ...
  return (
    ...
    >
      <div className="container">
        <h1 className="visually-hidden" id="exclusive-coffee-title">Premium
          Brews, Just for You
        </h1>
        <div className="exclusive-coffee__content">
          <div className="exclusive-coffee__header">
            <h2 className="exclusive-coffee__title-header h2 h2--width-lines">EXCLUSIVE
              Coffee
            </h2>
          </div>
            ...
            {listItems.map(({imgUrl, title, description, price, index}) => (
              <li className="exclusive-coffee__item" key={index}>
                ...
                <div className="exclusive-coffee__text">
                  <h2 className="exclusive-coffee__subtitle">
                    {title}
                  </h2>
                  <div className="exclusive-coffee__description">
                    <p>{description}</p>
                  </div>
                  <span className="exclusive-coffee__price price">
                      {price}
                    </span>
                </div>
              </li>
